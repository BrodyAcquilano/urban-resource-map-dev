...
function EditScoreModal({
  ...
  if (!selectedLocation) {
    return (
      <div className="edit-score-overlay">
        <div className="edit-score-modal">
          <h2>Edit Score</h2>
  ...
  <>
    ...
    {Object.values(locationData.resources || {}).some((val) => val) ? (
                ...
                <tr key={key}>
                  ...
                  <td>
                    <select
                      ...
                      onChange={(e) =>
                        handleScoreChange("resources", key, e.target.value)
                      }
                    >
                  ...
                  <td>{"⭐".repeat(locationData.scores.resources[key] || 0)}</td>
                </tr>
              ) : null
          )}
        </tbody>
      ...
      <p className="empty-message">No resources available at this location.</p>
    )}
  </>
)}
  ...
  <>
    ...
    {Object.values(locationData.services || {}).some((val) => val) ? (
                ...
                <tr key={key}>
                  ...
                  <td>
                    <select
                      ...
                      onChange={(e) =>
                        handleScoreChange("services", key, e.target.value)
                      }
                    >
                      <option value="">Select</option>
                      {[1, 2, 3, 4, 5].map((n) => (
                  ...
                  <td>{"⭐".repeat(locationData.scores.services[key] || 0)}</td>
                </tr>
              ) : null
          )}
        </tbody>
      ...
      <p className="empty-message">No services available at this location.</p>
    )}
  </>
)}
{page === 4 && (
  <>
    ...
    {Object.values(locationData.amenities || {}).some((val) => val) ? (
                ...
                <tr key={key}>
                  ...
                  <td>
                    <select
                      ...
                      onChange={(e) =>
                        handleScoreChange("amenities", key, e.target.value)
                      }
                    >
                      <option value="">Select</option>
                      {[1, 2, 3, 4, 5].map((n) => (
                  ...
                  <td>{"⭐".repeat(locationData.scores.amenities[key] || 0)}</td>
                </tr>
              ) : null
          )}
        </tbody>
      ...
      <p className="empty-message">No amenities available at this location.</p>
    )}
  </>
)}
